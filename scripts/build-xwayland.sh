...
stage_xwayland() {
    ...
    clone_pinned xwayland
    # Xwayland-24.1 has a meson build at the xserver root. Disable
    # everything we don't need: GLAMOR/GL, DRI3 (needs libdrm/xshmfence),
    # XAUTH/XDM/secure-rpc/SELinux, IPv6, listen_tcp.
